                    ...
                    public TableCell<PendingTradesListItem, PendingTradesListItem> call(
                        ...
                        return new TableCell<PendingTradesListItem, PendingTradesListItem>() {
                            ...
                            public void updateItem(final PendingTradesListItem item, boolean empty) {
                                super.updateItem(item, empty);
                                if (item != null && !empty)
                                    setText(formatter.formatBitcoinWithCode(item.getTrade().getTradeAmount()));
                                else
                                    setText(null);
                            }
                        };
                    ...
                    public TableCell<PendingTradesListItem, PendingTradesListItem> call(
                        ...
                        return new TableCell<PendingTradesListItem, PendingTradesListItem>() {
                            ...
                            public void updateItem(final PendingTradesListItem item, boolean empty) {
                                super.updateItem(item, empty);
                                if (item != null && !empty)
                                    setText(formatter.formatVolumeWithCodeAndLimitedDigits(item.getTrade().getTradeVolume(), item.getTrade().getOffer().getCurrencyCode()));
                                else
                                    setText(null);
                            }
                        };
